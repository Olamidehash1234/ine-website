export default function AboutSection() {
    return (
        <div className="px-[16px] pt-[60px] pb-[80px] sm:px-[80px] sm:pt-[80px] sm:pb-[120px]">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-[30px] items-center"> 
                <div>
                    ...
                    <p className="text-[24px] lg:text-[36px] font-medium lg:leading-[135%]">We are <span className="text-[#2563EB]">Image Nation EduTech</span>, a career building community helping students go beyond academics. Our focus is on real projects, mentorship, and using modern tools including AI  to prepare students for the future of work. We partner with schools to create opportunities that last a lifetime.</p>
                </div>
