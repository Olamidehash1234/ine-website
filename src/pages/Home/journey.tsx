export default function Journey() {
    return (
        <section className="px-[16px] pt-[60px] pb-[80px] sm:px-[80px] sm:pt-[80px] sm:pb-[120px]">
            ...
            <div className="mt-[20px] lg:mt-[60px] grid grid-cols-1 sm:grid-cols-4 gap-10 lg:gap-[0px]">
                <div className="flex flex-col gap-4 lg:gap-[30px] items-center">
                    ...
                    <div className="flex flex-col gap-[10px] items-center text-center">
                        ...
                        <p className="font-medium text-[#494949]">Students learn the basics: Frontend, Backend, UI/UX, and Project Management. Intro to AI as a tool, not a threat.</p>
                    </div>
                </div>
                ...
                <div className="flex flex-col gap-4 lg:gap-[30px] items-center">
                    <div className="flex flex-col gap-[10px] items-center text-center lg:mt-[58px]">
                        ...
                        <p className="font-medium text-[#494949]">Tech-for-School Project.
                ...
                <div className="flex flex-col gap-4 lg:gap-[30px] items-center">
                    ...
                    <div className="flex flex-col gap-[10px] items-center text-center">
                        ...
                        <p className="font-medium text-[#494949]">Continuous project work, mentorship, career guidance, AI & cloud exposure.</p>
                    </div>
                </div>
